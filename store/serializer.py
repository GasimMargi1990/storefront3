...
class ProductSerializer(serializers.ModelSerializer):
    ...
    price_with_tax = serializers.SerializerMethodField(method_name
                                                       ='calculate_tax')
...
class AddCartItemSerializer(serializers.ModelSerializer):
    ...
    def save(self, **kwargs):
        ...
        try:
             ...
             self.instacne = cart_item.save()
        except CartItem.DoesNotExist:
            self.instacne= CartItem.objects.create(cart_id = cart_id,**self.validated_data)
